const letters = [
  {
    svg:  `<svg class="mobile-letter-q" viewBox="0 0 55.847 102.192" width="55.847" height="102.192" xmlns="http://www.w3.org/2000/svg">
            <path fill="#fff" d="M14.69 56.23c-1.089-3.747 1.494-6.153 2.4-9.5 2.565-5.121 9.539-5 14.5-4.451 3.212.523 3.3.2 4.053-2.939 1.326-6.179 3.6-11.751 4.6-18.057-3.958 1.358-9.4 12.651-13.184 8.1-2.127-3.346-5.5-6-5.832-10.174C27.6 14.867 57.522-13.542 55.773 7.952 54.306 28.73 49.6 49.263 45.484 69.668c-2.263 18.305-10.437 35.258-31.808 32.155C-4.585 99.092-.444 75.332 2.983 62.337c1.227-3 5.278.828 7.615.55.981.123 2.026-.265 2.762.864 1.787 2.709.055 5.834-.58 8.635-1.384 4.319-.742 8.664-.133 12.977.875 6.716 10.6 2.877 12.882-1.633C29.943 75.922 38 62.938 33.5 54.255c-2.886-3.438-6.538-.525-7.385 2.976-1.9 3.182-8.4-.494-11.429-1"/>
          </svg>`,
  },
  {
    svg:  `<svg class="mobile-letter-a-bold" viewBox="0 0 34.847 46.314" width="34.847" height="46.314" xmlns="http://www.w3.org/2000/svg">
...
tableOfContents = [
  {
    id:0,
    svg: `<svg id="Group_63" data-name="Group 63" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="58.136" height="135.428" viewBox="0 0 58.136 135.428">
    <defs>
  ...
  {
    id:1,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="243.191" height="100.389" viewBox="0 0 243.191 100.389">
  ...
  {
    id:2,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="142.226" height="99.904" viewBox="0 0 142.226 99.904">
  ...
  {
    id:3,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="86.276" height="125.458" viewBox="0 0 86.276 125.458">
  ...
  {
    id:4,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="93.854" height="123.046" viewBox="0 0 93.854 123.046">
  ...
  {
    id:5,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="103.183" height="143.374" viewBox="0 0 103.183 143.374">
  ...
  {
    id:6,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="116.224" height="104.838" viewBox="0 0 116.224 104.838">
  ...
  {
    id:7,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="106.012" height="108.662" viewBox="0 0 106.012 108.662">
  ...
  {
    id:8,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="93.513" height="112.438" viewBox="0 0 93.513 112.438">
  ...
  {
    id:9,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="127.415" height="79.761" viewBox="0 0 127.415 79.761">
  ...
  {
    id:10,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="66.989" height="113.458" viewBox="0 0 66.989 113.458">
  ...
  {
    id:11,
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="116.445" height="128.006" viewBox="0 0 116.445 128.006">
...
const spanIconContents = document.querySelectorAll('.span-icon-contents');
function addSVGsToContents() {
  spanIconContents.innerHTML = '';
  for(let i = 0; i < spanIconContents.length; i++){
    spanIconContents[i].innerHTML = tableOfContents[i].svg;
  }
}
addSVGsToContents();
